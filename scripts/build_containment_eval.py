"""Derive a job-level containment/completion evidence table from P-015's local E2E report.
...
def build() -> None:
    ...
    md = f"""# Containment / completion evaluation
...
| Commercial completion / containment proxy | {completed}/{attempted} = {completed / attempted:.1%} |
| Completed autonomously without required human intervention | {autonomous}/{attempted} = {autonomous / attempted:.1%} |
