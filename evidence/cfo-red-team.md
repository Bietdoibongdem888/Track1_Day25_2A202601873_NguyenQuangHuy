...
6. **GM:** blended GM is 82.8%, below the 85% missing-cost trigger. Usage GM is 76.1%. The five-case controlled eval produces 80% grounded-package completion but only 20% autonomous completion; a 2x adverse package-completion error to 40% lowers usage GM to 56.1%, so the model does not celebrate an artificially tiny cost.
